            ...
            <div>
              {loadingStats ? (
                 ...
                 <p className="text-xl font-black text-gray-800" style={{ direction: 'ltr', textAlign: 'right' }}>
                    {Number(s.value).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-xs font-bold text-gray-400 ml-1 uppercase">ر.ي</span>
                 </p>
              )}
            </div>
          </div>
